...
export function CommandMenu({ isOpen, onClose }: CommandMenuProps) {
  ...
  const commandItems = useMemo(() => [
    ...
    { id: 'expertise', title: 'Expertise & Skills', category: 'Navigation', icon: '↗', action: () => scrollToSection('expertise') },
    { id: 'work', title: 'Selected Work', category: 'Navigation', icon: '↗', action: () => scrollToSection('work') },
    { id: 'featured', title: 'Featured: Kizuna Platform', category: 'Navigation', icon: '↗', action: () => scrollToSection('featured') },
